                                                ...
                                                <div class="featured-thumb-data shadow-one">
                                                    ...
                                                    <div class="bg-gray quantity px-4 pt-4">
                                                        <ul>
                                                            ...
                                                            <li><span><?php echo $row['6'];?></span> City</li>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-lg-4">
                                        <div class="footer-widget mb-4">
                                            ...
                                            <p class="pb-20 text-white">Risus commodo congue augue phasellus morbi
                                                hymenaeos ante tincidunt eu orci dictum bibendum lacus platea primis mi
                                                lacinia felis gravida natoque bibendum cubilia montes tristique et arcu
                                                blandit risus. Lobortis dignissim nam.</p>
                                            <p class="pb-20 text-white">Risus commodo congue augue phasellus morbi
                                                hymenaeos ante tincidunt eu orci dictum bibendum lacus platea primis mi
                                                lacinia felis gravida natoque</p>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 col-lg-4">
                                                <div class="footer-widget footer-nav mb-4">
                                                    <h4
                                                        class="widget-title text-white double-down-line-left position-relative">
                                                        Support</h4>
                                                    <ul class="hover-text-primary">
                                                        ...
                                                        <li><a href="#" class="text-white">Freequenly Ask Question</a>
                                                        </li>
                                            ...
                                            <div class="col-md-4 col-lg-4">
                                                ...
                                                <div
                                                    class="footer-widget media-widget mt-4 text-white hover-text-primary">
